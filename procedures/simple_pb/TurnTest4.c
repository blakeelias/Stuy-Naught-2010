...
printf("time: %2.0f, current_att: (%5.2f, %5.2f, %5.2f), target: (%5.2f, %5.2f, %5.2f), to_target: %5.1f, angle_diff: %5.1f",
time,current_att[0],current_att[1],current_att[2],target_att[0],target_att[1],target_att[2],
VAngle(current_att,target_att),VAngle(previous_att,current_att));
...
VCopy(current_att,previous_att);
